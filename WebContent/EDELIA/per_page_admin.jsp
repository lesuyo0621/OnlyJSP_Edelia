...
<%
	...
	String sql = "select * from edeliaorder order by ordernum DESC";
					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li class="active"><a href="per_page_admin.jsp">Order List</a></li>
							...
							<center><div class="editable" style="overflow:auto;">
									<table class="type09">
										...
										while(rs.next()) {
											...
											out.println("<tbody><tr><td>"+_date+"</th><td>"+_id+"</th><td>"+_menu+"</th><td>"+_memo+"</th><td>"+_state+"</th></tr></tbody>");
										}
										%>
									</table>
								</div></center>
