			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Read Our MENU</h3>
						<p>EDELIA is a relaxed atmosphere selling sweet snacks and sandwiches. <br />We invite you to travel with a taste of coffee.</p>
					</div>
				</div>
			</div>
						<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<a href="#"><img class="img-responsive" src="images/coffee1.jpg" alt=""></a>
					...
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<a href="#"><img class="img-responsive" src="images/drink.jpg" alt=""></a>
					...
					<div class="col-lg-4 col-md-4">
						<div class="fh5co-blog animate-box">
							<a href="#"><img class="img-responsive" src="images/desert.jpg" alt=""></a>
