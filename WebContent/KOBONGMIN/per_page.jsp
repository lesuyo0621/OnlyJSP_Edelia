...
<%
	...
	String sql = "select * from korder where id=? order by ordernum DESC";
					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<li class="active"><a href="per_page.jsp">Order List</a></li>
			...
			<div class="container">
						...
						<figure>
							<center><div class="editable" style="overflow:auto;">
									<table class="type09">
										...
										<thead>
											<tr>
												<th scope="cols"><center>날짜</center></th>
												<th scope="cols"><center>구매품목</center></th>
												<th scope="cols"><center>메시지</center></th>
												<th scope="cols"><center>상태</center></th>
											</tr>
										</thead>
										<% 
										while(rs.next()) {
											String _date = rs.getString("date");
											String _menu= rs.getString("menu");
											String _memo = rs.getString("memo");
											String _state = rs.getString("state");
											out.println("<tbody><tr><td>"+_date+"</th><td>"+_menu+"</th><td>"+_memo+"</th><td>"+_state+"</th></tr></tbody>");
										}
										%>
									</table>
								</div></center>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 animate-box">
						<h3>구매 시 확인사항</h3> 
						<p>1. 구매품목과 메시지를 다시한번 확인해주시기 바랍니다.<br/> 
						2. 주문이 성공적으로 등록되면 상태에 '주문 성공'라고 표시됩니다.<br/>
						3. 음식이 완료되면 '처리 완료'라고 표시됩니다. <br/>
						4. 만약, 오류가 있을 시에는 이델리아로 전화주시기 바랍니다.<br/>
						5. TEL : 010-2285-5238
						</p>
					</div>
				</div>
