...
<html>
	<head>
		...
		<script type="text/javascript">
			function sign_up() { 
				window.open('/SP/KOBONGMIN/login/signup.jsp', '', 'resizable=no,  scrollbars=yes, height=800, width=540, left='+ popupX + ', top='+ popupY + ', screenX='+ popupX + ', screenY= '+ popupY);
			}
			...
			function forgot_pwd() { 
				window.open('/SP/KOBONGMIN/login/forgot_password.jsp', '', 'resizable=no, height=800, width=520, left='+ popupA + ', top='+ popupB + ', screenA='+ popupA + ', screenB= '+ popupB);
			}
